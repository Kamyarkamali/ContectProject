...
function UserPanelcomponent() {
  return (
    <div className="flex flex-col items-center relative">
      ...
      <div className="flex bg-[#EAEAEA] items-center justify-around w-full p-3">
        <div className="border flex flex-col bg-white items-center justify-center w-[160px] shadow-md shadow-gray-200 rounded-lg h-[100px]">
        ...
        <div className="border w-[190px] shadow-md bg-white shadow-gray-200 rounded-lg h-[100px]">
